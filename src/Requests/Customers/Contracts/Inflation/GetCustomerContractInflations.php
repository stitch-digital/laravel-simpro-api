...
class GetCustomerContractInflations extends Request implements Paginatable
{
    ...
    {
        return '/companies/'.$this->companyId.'/customers/'.$this->customerId.'/contracts/'.$this->contractId.'/inflation/';
    }
}
