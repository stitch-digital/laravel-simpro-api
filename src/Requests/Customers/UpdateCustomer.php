...
class UpdateCustomer extends Request implements HasBody
{
     ...
     */
    public function __construct(protected readonly int $customerId, protected readonly int $companyId, protected readonly array $data, protected string $type = 'companies')
    {
        //
    }
