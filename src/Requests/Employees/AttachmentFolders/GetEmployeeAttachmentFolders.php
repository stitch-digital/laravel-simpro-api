...
class GetEmployeeAttachmentFolders extends Request implements Paginatable
{
    ...
    {
        return '/companies/'.$this->companyId.'/employees/'.$this->employeeId.'/attachments/folders/';
    }
}
