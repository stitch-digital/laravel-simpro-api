...
class CreateJobSectionCostCenterCatalogue extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/companies/'.$this->companyId.'/jobs/'.$this->jobId.'/sections/'.$this->sectionId.'/costCenters/catalogs/';
    }
