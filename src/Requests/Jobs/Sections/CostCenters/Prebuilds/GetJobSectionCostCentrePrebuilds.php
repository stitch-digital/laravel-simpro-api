...
class GetJobSectionCostCentrePrebuilds extends Request implements Paginatable
{
    ...
    {
        return '/companies/'.$this->companyId.'/jobs/'.$this->jobId.'/sections/'.$this->sectionId.'/costCenters/'.$this->costCenterId.'/prebuilds/';
    }
}
