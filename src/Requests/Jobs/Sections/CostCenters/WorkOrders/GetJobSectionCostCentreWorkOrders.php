...
class GetJobSectionCostCentreWorkOrders extends Request implements Paginatable
{
    ...
    {
        return '/companies/'.$this->companyId.'/jobs/'.$this->jobId.'/sections/'.$this->sectionId.'/costCenters/'.$this->costCenterId.'/workOrders/';
    }
}
