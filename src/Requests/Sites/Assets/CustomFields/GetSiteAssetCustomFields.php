...
class GetSiteAssetCustomFields extends Request implements Paginatable
{
    ...
    {
        return '/companies/'.$this->companyId.'/sites/'.$this->siteId.'/assets/'.$this->assetId.'/customFields/';
    }
}
