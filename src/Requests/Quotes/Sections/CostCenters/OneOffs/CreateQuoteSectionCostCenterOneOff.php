...
class CreateQuoteSectionCostCenterOneOff extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/companies/'.$this->companyId.'/quotes/'.$this->quoteId.'/sections/'.$this->sectionId.'/costCenters/oneOffs/';
    }
