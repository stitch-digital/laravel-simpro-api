...
class GetQuoteSectionCostCentreOneOffs extends Request implements Paginatable
{
    ...
    {
        return '/companies/'.$this->companyId.'/quotes/'.$this->quoteId.'/sections/'.$this->sectionId.'/costCenters/'.$this->costCenterId.'/oneOffs/';
    }
}
